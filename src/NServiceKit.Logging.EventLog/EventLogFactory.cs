...
namespace NServiceKit.Logging.EventLog
{
    /// <summary>
    ...
    public class EventLogFactory : ILogFactory
    {
        ...
        /// Initializes a new instance of the <see cref="EventLogFactory"/> class.
        /// </summary>
        /// <param name="eventLogName">Name of the event log. Default is 'NServiceKit.Logging.EventLog'</param>
        ...
        {
            this.eventLogName = eventLogName ?? "NServiceKit.Logging.EventLog";
